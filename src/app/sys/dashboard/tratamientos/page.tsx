...
import {TipoTratamiento} from "@/styles/imports";
                        ...
                        <div className="h-full flex flex-col items-center text-center">
                            ...
                            />
                                <div className="w-full">
                                    <h2 className="title-font font-medium text-lg text-gray-900">Tipo Tratamiento</h2>
                                    <h3 className="text-gray-500 mb-3">Añadir, Modificar y Eliminar Tipos de Tratamientos</h3>
                                    <Link href="/sys/dashboard/tratamientos">
                                        <button className="flex mx-auto mt-6 text-white bg-rose-900 border-0 py-2 px-5 focus:outline-none hover:bg-rose-300 rounded">
                                            Ir a Tipos de Tratamientos</button>
                                    </Link>
                                </div>
                        </div>
                    </div>
