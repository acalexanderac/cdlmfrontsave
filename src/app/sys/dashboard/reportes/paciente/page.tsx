...
const Procedimientos = () => {
    // Use useSession to get the user's session
                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                        ...
                        <div className="flex justify-between border-t border-gray-200 py-2">
                            ...
                            <button className="text-white bg-rose-900 border-0 py-2 px-5 focus:outline-none hover:bg-rose-300 rounded" onClick={() => {
