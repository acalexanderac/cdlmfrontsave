...
import CitasLists from "./citas.components/listtry";
    ...
    <> 
      ...
      <div className="pl-5">
         <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 pb-5">
                        ...
                        <span className="ml-3 text-2xl font-serif">Control de Citas</span>
                    </a>
                   
      </div>
      <div className="align-center pl-5 pb-10">
      <Link href="/sys/dashboard/citas/agregar">
        <button className="text-white bg-rose-900 border-0 py-2 px-6 focus:outline-none pl-5 hover:bg-rose-500 rounded text-lg">Agendar Cita</button>
        </Link>
