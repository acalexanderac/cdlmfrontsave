...
import ControlnatalLists from "./controlnatal.components/listtry";

function ControlNatalPageTSX() {
  return (
    <> 
      ...
      <div className="pl-5">
         <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 pb-5">
                        ...
                        <span className="ml-3 text-2xl font-serif">Control Pre y Post Natal</span>
                    </a>
                   
      </div>
      <div className="align-center pl-5 pb-10">
      <Link href="/sys/dashboard/procedimientosespec/controlnatal/agregar">
...
export default ControlNatalPageTSX