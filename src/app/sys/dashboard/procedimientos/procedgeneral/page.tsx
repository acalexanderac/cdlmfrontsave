...
import TipoProdList2 from "@/app/sys/dashboard/procedimientos/procedgeneral/procedgeneral.components/listry";
...
function PacientesCrud() {
  return (
    <> 
      ...
      <Link href="/sys/dashboard/procedimientos/procedgeneral/agregar">
