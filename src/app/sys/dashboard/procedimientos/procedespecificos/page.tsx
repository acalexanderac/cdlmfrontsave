...
import ProdList1 from "@/app/sys/dashboard/procedimientos/procedespecificos/procedimientos.components/listtry";
...
function PacientesCrud() {
  return (
    <> 
      ...
      <Link href="/sys/dashboard/procedimientos/procedespecificos/agregar">
