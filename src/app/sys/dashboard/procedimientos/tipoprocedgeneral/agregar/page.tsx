...
function TipoProdFormPage() {
  ...
  if (params['id']) {
    try {
      const res = await fetch(`http://localhost:3001/api/v1/treatmentypes/${params['id']}`, {
        method: 'GET',
        headers: {
    ...
    const handleDelete = async () => {
        ...
        if (window.confirm('Are you sure you want to delete?')) {
           await fetch(`http://localhost:3001/api/v1/treatmentypes/${params['id']}`, {
                method: 'DELETE',
               headers: {
                   'Content-Type': 'application/json',
                   Authorization: `Bearer ${session?.user?.token}`,
            ...
            router.push('/sys/dashboard/procedimientos/tipoprocedgeneral')
            router.refresh();
        }
    }
        ...
        <div className="flex flex-col justify-center items-center ">
            ...
            <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 pb-5">
                ...
                <span className="ml-3 text-2xl font-serif">
                  {
                      !params.id ? "Añadir Tipo Procedimiento General": "Editar Tipo Procedimiento General"
                  }
              </span>
            </a>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='px-5 py-5'>
                            <label htmlFor="name" className="block text-ls font-medium leading-6 text-gray-900">
                                Nombre del Tipo Procedimiento General
                            </label>
			...
			Obligatorio !
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        rounded text-lg" type='submit'>
                            {!params.id ? "Guardar Tipo Procedimiento General" : "Modificar Tipo Procedimiento General"}
