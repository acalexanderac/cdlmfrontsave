...
import TipoProdList2 from "@/app/sys/dashboard/procedimientos/tipoprocedespec/tipoprodgeneral.components/listtry";
    ...
    <> 
      ...
      <div className="pl-5">
         <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 pb-5">
                        ...
                        <span className="ml-3 text-2xl font-serif">Control de Tipo Procedimiento Específico</span>
                    </a>
                   
      </div>
      <div className="align-center pl-5 pb-10">
      <Link href="/sys/dashboard/procedimientos/tipoprocedespec/agregar">
        <button className="text-white bg-rose-900 border-0 py-2 px-6 focus:outline-none pl-5 hover:bg-rose-500 rounded text-lg">Agregar Tipo Procedimiento Específico</button>
        </Link>
