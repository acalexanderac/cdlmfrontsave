...
import Crioterapialists from "@/app/sys/dashboard/procedimientos/crioterapia/crioterapia.components/crioterapialists";
    ...
    <> 
      ...
      <div className="pl-5">
         <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 pb-5">
                        ...
                        <span className="ml-3 text-2xl font-serif">Crioterapias</span>
                    </a>
                   
      </div>
      <div className="align-center pl-5 pb-10">
      <Link href="/sys/dashboard/procedimientos/crioterapia/agregar">
        <button className="text-white bg-rose-900 border-0 py-2 px-6 focus:outline-none pl-5 hover:bg-rose-500 rounded text-lg">Agregar Crioterapia</button>
        </Link>
