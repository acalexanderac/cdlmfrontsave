        ...
        <div>
            ...
            <div className="bg-rose-100">
                <div className="flex-col flex w-full">
                    ...
                    <div className="flex bg-rose-100  overflow-x-hidden">
                        <div className="bg-rose-100 lg:flex md:w-64 md:flex-col hidden">
                                                ...
                                                <span className="justify-center items-center flex">
                                                    <span className="justify-center items-center flex">
                                                        <span className="justify-center items-center flex">
                                                            <span className="items-center justify-center flex">
                                                                <svg className="flex-shrink-0 w-5 h-5 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                                     viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" /><path strokeLinecap="round"
